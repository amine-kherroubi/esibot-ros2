"""
esibot_slam — launch/save_map.launch.py
========================================
Save the current SLAM map to disk as .pgm and .yaml files.

This launch file calls nav2_map_server's map_saver_cli, which reads
the /map topic and writes two files that together represent the
2D occupancy map built by slam_toolbox:
